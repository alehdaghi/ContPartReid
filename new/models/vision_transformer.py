...
from typing import Any, Callable, Dict, List, NamedTuple, Optional, Sequence, Tuple, Union, TypeVar
...
class Encoder(nn.Module):
    ...
    def forward(self, input: torch.Tensor):
        ...
        return self.ln(intermediates[-1]), intermediates[-2], intermediates[-3], intermediates[-4]
...
def _vision_transformer(
    ...
    hidden_dim: int,
    mlp_dim: int,
    weights: str, #Optional[WeightsEnum],
    progress: bool,
    **kwargs: Any,
) -> VisionTransformer:
    ...
    if weights:
        state_dict = load_state_dict_from_url(model_urls[weights],
                                              progress=progress)
...
def vit_b_16(*, weights: str = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_b_32(*, weights: str = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_16(*, weights: str = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_32(*, weights: str = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_h_14(*, weights: str = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
